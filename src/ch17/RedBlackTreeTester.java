...
public class RedBlackTreeTester {
   public static void main(String[] args) throws Exception {
      testFromBook();
      // insertionTest("ABCDEFGHIJ"); // ! this takes long time
      insertionTest("ABCDEFGHI");
   ...
   /**
    * Inserts all permutations of a string into a red-black tree and checks that it
    * contains the strings afterwards.
    * 
    * @param letters a string of letters without repetition
    * @throws Exception
    */
   public static void insertionTest(String letters) throws Exception {
      ...
      for (String perm : gen.getPermutations()) {
         ...
         // * E17.11
         if(!t.isRedBlack()){
            throw new Exception("Not a red black tree!");
         }
      }
   }

   /**
    * Tests removal, given a template for a tree with a black node that is to be
    * deleted. All other nodes should be given all possible combinations of red and
    * black.
    * 
