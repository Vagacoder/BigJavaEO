...
! Upgraded from Tree class:
! 1. add some traversal methods.
! 2. add breadth first iterator.
*/
public class TraversalTree {
    ...
    */
   public TraversalTree(Object rootData) {
      root = new Node();
      root.data = rootData;
    ...
    */
   public void addSubtree(TraversalTree subtree) {
