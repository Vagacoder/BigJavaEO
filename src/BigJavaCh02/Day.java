...
public class Day {
     ...
     * @param other
     *            the other day
     * @return the number of days that this day is away from the other (larger than
     *         0 if this day comes later than <code>other</code>)
     */
     ...
     * @param other
     *            the other day
     * @return a positive number if this day comes after the other day, a negative
     *         number if this day comes before the other day, and zero if the days
     *         are the same
     */
