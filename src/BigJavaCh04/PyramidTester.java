...
public class PyramidTester {
	public static void main(String[] args) {
		 ...
		 * http://en.wikipedia.org/wiki/Great_Pyramid_of_Giza, citing Levy, Janey
		 * (2005). The Great Pyramid of Giza: Measuring Length, Area, Volume, and
		 * Angles. Rosen Publishing Group. ISBN 1404260595.
		 */
