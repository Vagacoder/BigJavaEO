...
public class DoubleLinkedListTest {
   public static void main(String[] args) {
      ...
      DoubleListIterator iter = lst.listIterator();
   ...
   /**
    * Checks whether a linked list has the expected contents, and throws an
    * exception if not.
    * 
    * @param expected the letters that are expected in each node
    * @param actual   the linked list
    * @param what     a string explaining what has been tested. It is included in
    *                 the message that is displayed when the test passes.
    */
   public static void check(String expected, DoubleLinkedList actual, String what) {
      ...
      if (n > 0) {
         ...
         DoubleListIterator iter = actual.listIterator();
         for (int i = 0; i < n; i++) {
