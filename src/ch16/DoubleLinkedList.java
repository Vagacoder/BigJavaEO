...
public class DoubleLinkedList {
   ...
   class DoubleLinkedListIterator implements DoubleListIterator {
      ...
      /**
       * Returns the last node traversed by this iterator, or throws an
       * IllegalStateException if there wasn't an immediately preceding call to next
       * or previous.
       * 
